...
('Growth Jitters Lift Treasuries as Stocks Bounce: Markets Wrap',
 ...
 'Bloomberg', 'STOCK', TIMESTAMP '2026-03-30 11:49:18', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('Morgan Stanley''s Wilson Says S&P 500 Correction Nears End Stage',
 ...
 'Bloomberg', 'STOCK', TIMESTAMP '2026-03-30 09:10:53', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('Stocks Rise Pre-Bell, Oil Prices Jump as Traders Digest Trump''s Latest Comments on Iran',
 ...
 'Yahoo Finance', 'STOCK', TIMESTAMP '2026-03-30 11:39:30', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('Big Tech Stocks Rout Is Flashing Signals of a Turnaround',
 ...
 'Bloomberg', 'STOCK', TIMESTAMP '2026-03-30 11:28:15', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('Don''t Look Now, but the Federal Reserve''s March Inflation Forecast Just Worsened',
 ...
 'Motley Fool', 'MACRO', TIMESTAMP '2026-03-30 09:26:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('Citigroup holds firm on S&P 500 target despite Iran tensions',
 ...
 'TheStreet', 'STOCK', TIMESTAMP '2026-03-30 09:03:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('Dow Jones and Nasdaq futures called higher despite mixed message on Iran war',
 ...
 'Proactive Investors', 'STOCK', TIMESTAMP '2026-03-30 11:31:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('Stock Market Crash Likely Won''t Hurt 5 Safe High-Yielding Dividend Kings',
 ...
 '24/7 Wall St', 'STOCK', TIMESTAMP '2026-03-30 11:45:56', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('Dollar Under Pressure as Investors Weigh Rate Outlook Amid Geopolitical Risks',
 ...
 'Reuters', 'FOREX', TIMESTAMP '2026-03-30 08:15:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('EUR/USD Climbs to 3-Week High on Diverging Central Bank Expectations',
 ...
 'Bloomberg', 'FOREX', TIMESTAMP '2026-03-29 14:22:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('Won Weakens Past 1,380 as Safe-Haven Demand Boosts Dollar Against Asian FX',
 ...
 'Reuters', 'FOREX', TIMESTAMP '2026-03-28 10:45:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('Bitcoin Holds Above $84K as Crypto Markets Await Macro Catalysts',
 ...
 'CoinDesk', 'CRYPTO', TIMESTAMP '2026-03-30 10:30:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('Ethereum Gas Fees Hit 2-Year Low as Layer 2 Adoption Accelerates',
 ...
 'The Block', 'CRYPTO', TIMESTAMP '2026-03-29 16:15:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('Institutional Bitcoin ETF Inflows Resume After 2-Week Pause',
 ...
 'Bloomberg', 'CRYPTO', TIMESTAMP '2026-03-28 09:00:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('Gold Surges Past $3,100 on Middle East Escalation and Rate Cut Bets',
 ...
 'Reuters', 'COMMODITY', TIMESTAMP '2026-03-30 11:00:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('Oil Jumps 4% as Iran Tensions Threaten Strait of Hormuz Supply Routes',
 ...
 'Bloomberg', 'COMMODITY', TIMESTAMP '2026-03-30 10:15:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('Copper Rallies on China Stimulus Hopes and Supply Constraints',
 ...
 'Reuters', 'COMMODITY', TIMESTAMP '2026-03-29 13:45:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('Natural Gas Prices Climb as Late-Season Cold Snap Boosts Heating Demand',
 ...
 'Barchart', 'COMMODITY', TIMESTAMP '2026-03-28 15:30:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('Treasury Yields Fall as Flight to Safety Intensifies Amid War Fears',
 ...
 'Reuters', 'BOND', TIMESTAMP '2026-03-30 09:30:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('Yield Curve Steepens as Short-End Rates Price In More Fed Cuts',
 ...
 'Bloomberg', 'BOND', TIMESTAMP '2026-03-29 11:20:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('US Consumer Confidence Falls to Lowest Level Since 2022 on War and Inflation Concerns',
 ...
 'Reuters', 'MACRO', TIMESTAMP '2026-03-29 14:00:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('ISM Manufacturing PMI Expected to Show Continued Contraction in March',
 ...
 'CNBC', 'MACRO', TIMESTAMP '2026-03-30 07:45:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('PCE Inflation Data Due Friday — Why This Is the Most Important Number for Fed Policy',
 ...
 'Yahoo Finance', 'MACRO', TIMESTAMP '2026-03-28 08:30:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
